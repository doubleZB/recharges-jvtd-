                ...
                <div class="box-content">
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 z_cz_tabContent">
                        ...
                        <div class="z_taocan" id="productdisplay" style="width: 500px;">
                            <span class="label">10元</span>
                            <span class="label">20元</span>
                            <span class="label">30元</span>
                            <span class="label">50元</span>
                            <br>
                            <span class="label">100元</span>
                            <span class="label">200元</span>
                        </div>
                        ...
                        if(mobile!=""){
                            if(!(/^1[3456789]\d{9}$/.test(mobile))){
                                ...
                                $.ajax({
                                    ...
                                    data:{"mobile":mobile,"userId":userId,"bussinessType":bussinessType,"appType":appType},
                                    async:false,
                                    type:'POST',
                                    dataType:"json",
                                    success: function(data){
                                        var html="";
                                        var objnumSection = eval(data.numSection);
                                        if(objnumSection==null){
                                            alert("该手机号段不支持，请选择别的手机号");
                                        }else {
                                            if(eval(data.identification)!=0){
                                                alert("该手机号段不支持，请选择别的手机号");
                                            }
                                            $("#address").text( objnumSection.mobileProvince + objnumSection.mobileTypeName.substring(2,6) ).css("color", "#00DB00");

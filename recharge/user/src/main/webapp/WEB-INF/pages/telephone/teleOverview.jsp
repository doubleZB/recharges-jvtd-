                ...
                <div class="col-lg-12">
                    <div class="col-border clearfix col-margin-bottom">
                        ...
                        <ul class="tabChange" id="tabChange">
                            <li class="active" onclick="telAmount()">交易金额</li>
                            <li onclick="telSumOrderNum()">订单数</li>
                            <li onclick="telSuccessOrderNum()">成功率</li>
                        </ul>
    ...
    <div class="row z_tjbb" style="margin-top:20px;font-size:14px;">
        <div class="col-lg-12">
            <div class="col-border clearfix col-margin-bottom">
                <div class="z_info_tit">
                    详细报表
                    <button type="button" onclick="teleExcelExport()">下载表格</button>
                </div>
...
<script type="text/javascript">
    ...
    //订单数按钮触发事件
    function telSumOrderNum(){
        var updateTime= $("#doc-select-2 option:selected").text();
        if(updateTime==""||updateTime==null){
            alert("请选择数据时间");
        }
        telSumOrderNumData(function (json) {
            myChart.hideLoading();
            myChart.setOption({
                tooltip: {
                    trigger: 'axis',
    ...
    function telSumOrderNumData(cb) {
        var updateTime= $("#doc-select-2 option:selected").text();
        var businessType=${businessType};
        var docSelect1 =$("#doc-select-1").val();
        var updateTime= $("#doc-select-2 option:selected").text();
    ...
    //成功率按钮触发事件
    function telSuccessOrderNum(){
        var updateTime= $("#doc-select-2 option:selected").text();
        if(updateTime==""||updateTime==null){
            alert("请选择数据时间");
        }
        telephoneSuccessOrderNumData(function (json) {
            myChart.setOption({
                tooltip: {
    ...
    function telephoneSuccessOrderNumData(cb) {
        var businessType=${businessType};
        var docSelect1 =$("#doc-select-1").val();
        var updateTime= $("#doc-select-2 option:selected").text();
        if(docSelect1==1){

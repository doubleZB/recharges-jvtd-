                        ...
                        <div style="margin-top:10px;overflow: auto;">
                            <div class="col-lg-4 col-md-4 col-xs-4">
                                <div class="z_tody_record">
                                    <span id="trading_volume" class="z-all auto_center" style="font-size:40px;">0</span>
                                </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-xs-4">
                                <div class="z_tody_record" style="height: 62px;">
                                    <span id="order_quantity" class="auto_center" style="font-size:40px;">0</span>
                                </div>
                                <p class="z_record_deco">
                                        <span>
                                            订单数
                            ...
                            <div class="col-lg-4 col-md-4 col-xs-4">
                                <div class="z_tody_record">
                                    <span id="success_rate" class="auto_center" style="font-size:40px;">0.00%</span>
                                </div>
                                <p class="z_record_deco">
                                        <span>
                                            成功率
                ...
                <div class="col-lg-12">
                    <div class="col-border clearfix col-margin-bottom">
                        ...
                        <ul class="tabChange" id="tabChange">
                            ...
                            <li class="active" onclick="submitFrom()">交易金额</li>
                            <li onclick="sumOrderNum()">订单数</li>
                            <li onclick="successRate()">成功率</li>

                        </ul>
                        <div class="col-lg-12" style="line-height:30px;height:30px;">
                            <form class="am-form form_wrap">
                                <fieldset class="am-g">
                                    <div class="am-form-group am-u-lg-2" style="margin-right:-15px;">
                                        <select id="doc-select-1" style="width: 200px;">
                                    ...
                                    <div class="am-form-group am-u-lg-2" style="float:left;">
                                        <select id="doc-select-2" style="width: 200px;">
                                        </select>
                                        <span class="am-form-caret"></span>
                                    </div>
    ...
    <div class="row z_tjbb" style="margin-top:20px;font-size:14px;">
        <div class="col-lg-12">
            <div class="col-border clearfix col-margin-bottom">
                <div class="z_info_tit">
                    详细报表
                    <button type="button" id="flowExcelExport">下载表格</button>
                </div>
...
<script type="text/javascript">
    ...
    //数据表格下载
    $("#flowExcelExport").click(function () {
    ...
    function getYesterDayflow() {
        ...
        $.ajax({
            ...
            success: function (data) {
                //交易额，订单数，成功
                var trading_volume = $("#trading_volume").text(data.amount);
                var order_quantity = $("#order_quantity").text(data.sumOrderNum);
                var success_rate = $("#success_rate").text(data.successRate);
            }
        });
    }
        ...
        if (docSelect1 == 1) {
            ...
            $.ajax({
                ...
                success: function (resp) {
                    ...
                    $("#userFlowDataList").empty();
                    $("#userFlowDataList").append(listString);
                },
            });

    ...
    <div class="row">
        <div class="am-u-lg-12" style="padding:0;">
            <div class="am-u-lg-12 m-box m-market" style="padding:0;background:#eee;">
                <ul class="z_list">
                    <li>代码描述：视频会员直充接口,视频会员查询接口,状态回调接口</li>
                </ul>
                    <pre>
                        <code>
                            ...
                            */
                            @Test
                            public void testVideoSubmit() throws Exception {
                            ...
                            String code = "700001";//产品编码
                            String operator = "4";//优酷
                            ...
                            String url = "http://api.rd.yunpaas.cn/gateway/video/charge";
                            ...
                            */
                            ...
                            String url = "http://api.yunpaas.cn/gateway/video/queryOrder";

                        ...
                        <div class="am-tabs-bd">
                            <div class="am-tab-panel am-fade am-in am-active" id="tab1">
                                <div class="am-u-lg-3 am-u-md-4" style="padding:0;">
                                    <ul class="z_leftList">
                                        <li class="active"><a href="javascript:;">1.流量直充接口</a></li>
                                ...
                                <div class="am-u-lg-9 am-u-md-8 rightHeight">
                                    ...
                                    <div id="change1">
                                        <ul>
                                            <li>接口地址：http://api.yunpaas.cn/gateway/flow/charge</li>
                                            <li>请求方式：http post/get</li>
                                            <li>请求示例：http://api.yunpaas.cn/gateway/flow/charge?
                                    ...
                                    <div id="change2">
                                        <ul>
                                            <li>接口地址：http://api.yunpaas.cn/gateway/flow/queryOrder</li>
                                            <li>支持格式：json</li>
                                            <li>请求方式：http post/get</li>
                                            <li>请求示例：http://api.yunpaas.cn/gateway/flow/queryOrder?
                            ...
                            <div class="am-tab-panel am-fade" id="tab4">
                                ...
                                <table class="am-table">
                                    ...
                                    <tr>
                                        <td>JAVA</td>
                                        <td>
                                            <a class="z_fBlue" href="<%=request.getContextPath()%>/developer/flowJavaCode.do">流量示例代码</a>
                                        </td>
                                    </tr>

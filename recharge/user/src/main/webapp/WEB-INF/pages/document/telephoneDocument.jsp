            ...
            <div class="am-u-lg-12 m-box m-market" style="padding:0;">
                <div class="am-u-lg-12 z_head">
                    ...
                    <div class="am-u-lg-5 am-u-md-6 z_describe">
                        ...
                        <p class="am-u-lg-12" style="margin:10px 0 15px 0;font-size:12px;color:#666;padding:0;">移动联通电信手机话费快速充值</p>
                ...
                <div class="am-u-lg-12 z_content" style="padding: 0 40px;-webkit-user-select:text;-moz-user-select:text;-o-user-select:text;user-select:text;">
                    <div class="am-tabs" data-am-tabs>
                        <ul class="am-tabs-nav am-nav am-nav-tabs">
                            <li class="am-active"><a href="#tab1">API</a></li>
                            <li onclick="telPrice()"><a href="#tab3">商品编码</a></li>
                            <li><a href="#tab4">示例代码</a></li>
                        </ul>

                        <div class="am-tabs-bd"  style="-webkit-user-select:text;-moz-user-select:text;-o-user-select:text;user-select:text!important;">
                            <div class="am-tab-panel am-fade am-in am-active" id="tab1">
                                <div class="am-u-lg-3 am-u-md-4" style="padding:0;">
                                    <ul class="z_leftList">
                                        <li><a href="javascript:;">1.话费直充接口</a></li>
                                ...
                                <div class="am-u-lg-9 am-u-md-8 rightHeight">
                                    ...
                                    <div id="change1">
                                        <ul>
                                            <li>接口地址：http://api.yunpaas.cn/gateway/telbill/charge</li>
                                            <li>支持格式：json</li>
                                            <li>请求方式：http post/get</li>
                                            <li>请求示例：http://api.yunpaas.cn/gateway/telbill/charge?token=371022eb798f4f9ba8548e5053b23b1d&mobile=13822227777&customId=371022eb798f4f9ba8548e5053b23b1d&callbackUrl=您的话费充值回调地址&code=400001</li>
                                            <li>接口备注：话费直充接口</li>
                                        </ul>
                                        ...
                                        <table class="am-table">
                                            ...
                                            <tr>
                                                ...
                                                <td>string</td>
                                                <td>是</td>
                                                <td>校验值 md5(token+mobile+customId+code+callbackUrl),转小写</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    ...
                                    <div id="change2">
                                        <ul>
                                            <li>接口地址：接口地址：http://api.yunpaas.cn/gateway/telbill/queryOrder</li>
                                            <li>支持格式：json</li>
                                            <li>请求方式：http post/get</li>
                                            <li style="line-height:30px;">请求示例：http://api.yunpaas.cn/gateway/telbill/queryOrder?
                                                customId=121416480303073133&token=0303073133982347</li>
                                            <li style="line-height:30px;">接口备注：查询订单的最新状态，请确认订单成功提交后，再进行查询
                                        </ul>
                                        <p class="z_tabTit">请求参数说明:</p>
                                        <table class="am-table">
                                            <thead>
                                    ...
                                    <div id="change3">
                                        <ul>
                                            ...
                                            <li>请求方式：http post/get</li>
                                            <li style="line-height:30px;">请求示例：http://abc.com?mobile=13811118888&status=1&customId=fb1ed32a9540c24b03cc0c06aabbb642&sign=fb1ed32a9540c24b03cc0c06aabbb642</li>
                            ...
                            <div class="am-tab-panel am-fade" id="tab3">
                                <p class="z_tabTit z_fontWeight">商品及对应编码：</p>
                                <input type="hidden" name="userId" id="userId" value="${users.id}">
                                <input type="hidden" name="businessType" id="businessType" value="2">
                                <table class="am-table">
                                    <tr style="background:#eee;border-color:#eee!important;">
                                        <th>面值（元）</th>
                                        <th>编码</th>
                            ...
                            <div class="am-tab-panel am-fade" id="tab4">
                                ...
                                <table class="am-table">
                                    ...
                                    <tr>
                                        <td>JAVA</td>
                                        <td>
                                            <a class="z_fBlue" href="<%=request.getContextPath()%>/developer/telbillJavaCode.do">话费示例代码</a>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>

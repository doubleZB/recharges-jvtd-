 ...
 */
@Service("chargeSendSlowService")
public class ChargeSenderSlowService {
...
//                String channelNum;
//                if("flowningxiaxunda".equals(chargeRequest.getSupplyName())  || "flowningxiaxundaSF".equals(chargeRequest.getSupplyName())){
//                    channelNum=CommonUtil.getChannelNumTwo();
//                }else{
//                    channelNum=CommonUtil.getChannelNum();//流水
//                }
            ...
            log.info("订单编号"+orderNum+",手机号:"+chargeRequests.getMobile()+"订单发送执行时长:"+(endReportHandletime-startReportHandletime));
        }catch (Exception e) {

    ...
    <div class="admin-content-body">
        <div class="am-tabs" data-am-tabs="{noSwipe: 1}">
            <ul class="am-tabs-nav am-nav am-nav-tabs">
                <li id="table1" class="am-active"><a href="#tab1">入库单管理</a></li>
            ...
            <div class="am-tabs-bd am-tabs-bd-ofv">
                <div class="am-tab-panel am-active" id="tab1" style="padding-top:0;">
                    <form class="am-form-inline" role="form">
                        ...
                        <div class="am-form-group">
                            <input  type="text" name="serialNum" id="serialNum" class="am-form-field" placeholder="入库单编号" style="width: 150px;float: left;">
                        </div>
                        <div class="am-form-group">
                            <select  class="select1" name="cardSize" id="cardSizeD" style="width: 150px;float: left;padding: .5em;" placeholder="物理大小">
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-form-group">
                                <select class="select1" name="operator" id="supplierName"style="width: 150px;float: left;padding: .5em;" placeholder="供应商">
                        ...
                        <div class="am-form-group demo1" style="margin-top: 20px">
                            <input type="text" class="am-form-field"  id="purchaseNum" placeholder="采购单编号"style="width: 150px;float: left;">
                        </div>
                         <div class="am-form-group">
                                <input  type="text" name="createrName" id="createrName" class="am-form-field" placeholder="入库人" style="width: 150px;float: left;">
                        </div>
                    ...
                    <table class="am-table am-table-striped am-table-hover">
                        ...
                        <tr v-for="item in json">
                            ...
                            <td>{{item.inReceiptStatusLiteral}}</td>
                            <td>{{item.createrName}}</td>
                            <td>{{item.createTime.substring(0,19)}}</td>
                            <td>
                                <a v-if="item.inReceiptStatus==3 || item.inReceiptStatus==4" onclick="editDisplay('{{item.purchaseSerialNum}}')" class="am-btn am-btn-link"style="padding: 0;color: #0e90d2;">入库</a>
                                <a onclick="exportInReceipt({{item.id}})" class="am-btn am-btn-link"style="padding: 0;color: #0e90d2;">卡明细</a>
                            </td>
                        </tr>
                    </table>
                ...
                <div class="am-tab-panel" id="tab2">
                    <form class="am-form am-form-horizontal">
				        <div class="am-form-group">
				            <label  class="am-u-sm-2 am-form-label">采购单编号：</label><em>*</em>
				            <div style="width: 300px;float: left;">
					            <input type="text" name="purchaseSerialNum" id="purchaseSerialNum" onblur="toDisplay()">
                        ...
                        <div class="am-form-group">
                            ...
                            <div style="width: 300px;float: left;">
                                <input type="text" name="productId" id="productId" disabled="disabled" >
                                <span class="msg_name"></span>
                            </div>
                        </div>
                        <div class="am-form-group">
                            ...
                            <div style="width: 300px;float: left;">
                                <input type="text" name="cardSize" id="cardSize" disabled="disabled" >
                                <span class="msg_name"></span>
                            </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div style="width: 300px;float: left;">
                                <input type="text" name="costDiscount" id="costDiscount" disabled="disabled" >
                                <span class="msg_name"></span>
                            </div>
                        </div>
                        <div class="am-form-group">
                        ...
                        <div class="am-form-group">
                            ...
                            <div style="width: 300px;float: left;">
                                <input type="file" name="importExcel" id="importExcel" accept="application/vnd.ms-excel,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet">
                                <span class="msg_name"></span>
                            </div>
                        </div>
                        <div class="am-form-group">
                    ...
                    <div style="clear:both">
                        <button  class="am-btn am-btn-warning" id="Add"
                                 style="width: 120px;margin: auto;margin-left: 176px;background-color: #0e90d2; border-color: #0e90d2;" onclick="insertInReceipt()">提交
                        </button>
...
<div class="tab_cardIn" style="display:none;">
    ...
    <form class="am-form am-form-horizontal">
        ...
        <div class="am-form-group">
            <label  class="am-u-sm-2 am-form-label">卡信息文件：</label><em>*</em>
            <div style="width: 300px;float: left;">
                <input type="file" name="importExcelI" id="importExcelI" accept="application/vnd.ms-excel,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet">
                <span class="msg_name"></span>
            </div>
        </div>
        <div class="am-form-group">
    ...
    <div class="am-form-group">
        <button class="am-btn am-btn-warning" id="update" style="width: 120px;margin: auto;margin-left: 176px;" onclick="addInReceipt()">提交</button>
...
<script>
    ...
    function initPage (){
    $.ajax({
        url: "${pageContext.request.contextPath}/iot/cardIn/list?pageNumber=1&pageSize=10",
        type:'POST',
        async:false,
        data:{},
        dataType:"json",
    ...
    //卡明细
    function exportInReceipt(inReceiptId){
        window.open("/iot/cardIn/exportInReceipt?inReceiptId="+inReceiptId)
    }
    ...
    function reloadPage(pageNum){
        ...
        var inReceiptStatus=$("#inReceiptStatus").val();
        var cardSize = $("#cardSizeD").val();
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/iot/cardIn/list.do?pageNumber="+pageNum+"&pageSize=10",
            type:'POST',
            dataType:"json",
            async:false,
            data:{
                ...
                purchaseSerialNum:purchaseNum,
                cardSize:cardSize,
                supplyId:supplierName,
                productId:product,
                beginTime:beginTime,
                endTime:endTime,
                operator:operator
...
<script>
    ...
    function toDisplay(){
        ...
        $.ajax({
            url:"${pageContext.request.contextPath }/iot/cardIn/toDisplay.do",
            type:"post",
            data:{purchaseSerialNum:purchaseSerialNum},
            dataType:"json",
            success:function (data){
    ...
    //回显采购单信息
    function editDisplay(purchaseSerialNum){
        $.ajax({
            url:"${pageContext.request.contextPath }/iot/cardIn/toDisplay.do",
            type:"post",
            data:{

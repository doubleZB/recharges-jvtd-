            ...
            <table>
                <c:forEach items="${list}" var="q">
                    <tr style="display: none">
                        <td id="authID">${q.id}</td>
                    </tr>
                    <tr>
                        <td class="td_first">商户类型：</td>
                        <td>${q.userType==1?"企业":q.userType==2?"个人":" "}</td>
                    </tr>
                    <tr>
                        <td class="td_first">公司全称：</td>
                        <td>${q.userAllName}</td>
                    </tr>
                    <tr style="display: none">
                        <td class="td_first">审核状态：</td>
                        <td id="authState">${q.authState}</td>
                    </tr>
                    <tr>
                        <td class="td_first">营业执照编号：</td>
                        <td>${q.businessLicenseNum}</td>
                    </tr>
                    <tr>
                        <td class="td_first">营业执照副本：</td>
                        <td><a href="####" class="btn1">查看</a></td>
                    </tr>
                    <tr class="img1">
                        <td class="td_first"></td>
                        <td><img src="//<%=path%>/<%=FileName%>/${q.businessLicenseImage}"></td>
                    </tr>
                </c:forEach>
                <tr>
                    <td></td>
                    <td style="color:#A1A1A1;">审核要求：营业执照副本信息全面，清晰，所展示信息与上述填写信息保持一致。</td>
                </tr>
                <tr>
                    <td></td>
                    <td>
